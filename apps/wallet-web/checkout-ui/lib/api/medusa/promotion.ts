...
import { getAuthHeaders } from "@/checkout-ui/lib/data/cookies"
import type { PromotionsResponseDto } from "@/checkout-ui/lib/types/dto/promotion"
import medusaError from "@/checkout-ui/lib/utils/medusa-error"
import { ApiAuthError } from "@/checkout-ui/lib/api/api-error"
