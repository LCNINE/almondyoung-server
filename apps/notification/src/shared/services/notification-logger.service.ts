...
import { notificationLogs, NewNotificationLog } from '../../../database/schemas/notification-schema';
...
export class NotificationLoggerService {
  ...
  async getStats(params: { startDate?: Date; endDate?: Date; userId?: string; channel?: string }) {
