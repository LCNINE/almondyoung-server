...
export type CreatePlanInput = Pick<NewPlan, 'tierId' | 'price' | 'durationDays' | 'currency' | 'trialDays'>;
export type UpdatePlanInput = Partial<Pick<Plan, 'price' | 'durationDays' | 'currency' | 'trialDays' | 'isActive'>>;
...
export type PlanInfo = Pick<Plan, 'id' | 'price' | 'durationDays' | 'currency' | 'trialDays'>;
