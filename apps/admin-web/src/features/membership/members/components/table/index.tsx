...
import { useMembershipMemberTableFilters } from '@/hooks/table/filters/use-membership-member-table-filters';
...
export function MembershipMemberTable() {
  ...
  const columns = useMembershipMemberTableColumns();
  const filters = useMembershipMemberTableFilters();
