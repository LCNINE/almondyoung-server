...
import { useUpdateChannel } from '@/lib/api/domains/sales-channel';
...
export function ApiKeyDialog({
  ...
  const isSmartstore = useMemo(
    () => channel?.type === 'naver_smartstore',
    [channel]
  );
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          <DialogTitle>
            API 연동키 수정{channel ? ` – ${channel.name}` : ''}
          </DialogTitle>
        </DialogHeader>
