...
export const useAdjustStock = () => {
    ...
    return useMutation({
        mutationFn: (data: any) => Promise.resolve({ success: true, adjustment: data }),
        onSuccess: () => {
...
export const useRebuildStockSummary = () => {
    ...
    return useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: inventoryQueryKeys.stockSummary });
        },
    });
};
...
export const useCancelStockEvent = () => {
    ...
    return useMutation({
        mutationFn: (eventId: string) => Promise.resolve({ success: true, eventId }),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: inventoryQueryKeys.stocks });
        },
    });
...
export const useCreateWarehouse = () => {
    ...
    return useMutation({
        mutationFn: (data: any) => Promise.resolve({ id: 'new-warehouse-id', ...data }),
        onSuccess: () => {
