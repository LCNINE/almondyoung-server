...
export const productQueryKeys = {
    ...
    categoryChildren: (id: string) => [...productQueryKeys.category(id), 'children'] as const,
    categoryPath: (id: string) => [...productQueryKeys.category(id), 'path'] as const,

    // 제품 마스터 관련
    masters: ['masters'] as const,
    mastersList: (query: Record<string, any>) => [...productQueryKeys.masters, 'list', query] as const,
    master: (id: string) => [...productQueryKeys.masters, id] as const,
    masterPricePreview: (id: string) => [...productQueryKeys.master(id), 'price-preview'] as const,
    ...
    variantPrice: (id: string) => [...productQueryKeys.variant(id), 'price'] as const,

    // 판매 채널 관련
    channels: ['channels'] as const,
    channelsList: (query: Record<string, any>) => [...productQueryKeys.channels, 'list', query] as const,
    activeChannels: () => [...productQueryKeys.channels, 'active'] as const,
    channel: (id: string) => [...productQueryKeys.channels, id] as const,
    channelsByType: (type: string) => [...productQueryKeys.channels, 'type', type] as const,
    ...
    channelProduct: (id: string) => [...productQueryKeys.channelProducts, id] as const,
    mergedChannelProduct: (masterId: string, channelId: string) =>
        [...productQueryKeys.channelProducts, 'merged', masterId, channelId] as const,
