...
export const useUpdatePricingStrategy = () => {
    ...
    return useMutation({
        mutationFn: ({ id, data }: { id: string; data: UpdatePricingStrategyDto }) =>
...
export const useBulkUpdateVariants = () => {
    ...
    return useMutation({
        mutationFn: (data: BulkUpdateVariantDto) => products.variants.bulkUpdate(data),
        onSuccess: () => {
            queryClient.invalidateQueries({
                queryKey: productQueryKeys.variants,
            });
...
export const useValidateChannelConfig = () => {
    return useMutation({
        mutationFn: (data: ValidateChannelConfigDto) => products.channels.validateConfig(data),
    });
};
...
export const useCreateChannelProduct = () => {
    ...
    return useMutation({
        mutationFn: (data: CreateChannelProductDto) => products.channelProducts.create(data),
        onSuccess: () => {
            queryClient.invalidateQueries({
...
export const useUpdateChannelProductName = () => {
    ...
    return useMutation({
        mutationFn: ({ id, data }: { id: string; data: UpdateChannelProductNameDto }) =>
...
export const useUpdateChannelProductStatus = () => {
    ...
    return useMutation({
        mutationFn: ({ id, data }: { id: string; data: UpdateChannelProductStatusDto }) =>
