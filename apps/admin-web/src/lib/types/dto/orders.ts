...
// ===== 공통 타입 =====
export type SalesOrderStatus = 'created' | 'confirmed' | 'picking' | 'shipped' | 'delivered' | 'canceled' | 'returned';
export type FulfillmentStatus = 'created' | 'shipped' | 'canceled';
export type PurchaseOrderStatus = 'created' | 'confirmed' | 'shipped' | 'delivered' | 'canceled';
