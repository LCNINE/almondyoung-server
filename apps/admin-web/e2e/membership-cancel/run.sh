...
SCENARIOS="${SCENARIOS:-annual monthly-cms scheduled one-time one-time-scheduled pg-settled pg-pending no-payment no-payment-active legacy-detail cancellation-list external-refund refunded-account}"
PORT="${E2E_PORT:-4800}"
