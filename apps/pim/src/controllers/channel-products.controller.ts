...
} from '../schemas/channel-products.schema';
...
export class ChannelProductsController {
  ...
  @ApiResponse({
    status: 400,
    description: '잘못된 요청 데이터 (masterId, channelId 필수)',
  })
  @ApiResponse({
    status: 404,
  ...
  @ApiParam({ name: 'id', description: '채널 제품 ID' })
  @ApiBody({
    type: UpdateChannelProductDto,
    description: '수정할 채널 제품 정보',
  })
  @ApiResponse({
    status: 200,
    description: '채널 제품 수정 성공',
    type: ChannelProductDto,
  })
  ...
  @ApiResponse({
    status: 200,
    description: '병합된 채널 제품 조회 성공',
    type: MergedChannelProductDto,
  })
  @ApiResponse({ status: 400, description: '잘못된 요청' })
  @ApiResponse({ status: 404, description: '채널 제품을 찾을 수 없음' })
  @ApiResponse({ status: 500, description: '서버 오류' })
  ...
  @ApiOperation({
    summary: '제품명 덤어쓰기',
    description: '채널별 제품의 이름을 덤어쓰기합니다.',
  })
  @ApiParam({ name: 'id', description: '채널 제품 ID' })
  ...
  @ApiOperation({
    summary: '채널 제품 상태 설정',
    description: '채널 제품의 활성/비활성 상태를 설정합니다.',
  })
  @ApiParam({ name: 'id', description: '채널 제품 ID' })
  @ApiBody({
    type: SetChannelProductActiveDto,
