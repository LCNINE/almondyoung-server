...
import { LocationQueryDto, ColumnQueryDto, RackQueryDto } from '../dto/location-query.dto';
import {
...
export class LocationController {
  ...
  @ApiResponse({
    ...
    schema: {
      oneOf: [{ $ref: getSchemaPath(StandardLocationResponseDto) }, { $ref: getSchemaPath(ZoneLocationResponseDto) }],
    },
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
