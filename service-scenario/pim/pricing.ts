...
export const pricingScenarios: Scenario[] = [
  ...
  // ========================================
  {
    ...
    steps: [
      ...
      },
      {
        ...
        method: 'PUT',
        path: '/versions/{{versionId}}/pricing/rules',
        service: 'pim',
        body: {
          basePriceRules: [
            {
  ...
  // ========================================
  {
    ...
    steps: [
      ...
      },
      {
        id: 'calculate-price',
        method: 'POST',
        path: '/masters/{{masterId}}/pricing/calculate',
        service: 'pim',
        body: {
        ...
        expectedStatus: 200,
        description: 'Regular 고객 가격 계산 (active 버전 사용)',
        responseSchema: z.object({
          variantId: z.string(),
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Membership 고객 가격 계산 (active 버전 사용)',
        responseSchema: z.object({
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: '5개 구매 (tiered 미적용, active 버전 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: '15개 구매 (10개 이상 5% 추가 할인, active 버전 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: '120개 구매 (100개 이상 10% 추가 할인, active 버전 사용)',
        responseSchema: z.object({
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Red/S variant 가격 계산 (active 버전 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Blue/S variant 가격 계산 (active 버전 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Green/S variant 가격 계산 (active 버전 사용)',
        responseSchema: z.object({
          price: z.literal(10000),
        }),
      },
  ...
  // ========================================
  {
    ...
    steps: [
      ...
      },
      {
        id: 'get-price-set',
        method: 'GET',
        path: '/masters/{{masterId}}/pricing/price-set',
        service: 'pim',
        queryParams: {
          variantId: '{{variantId}}',
        },
        expectedStatus: 200,
        description: '가격 세트 조회 (active 버전 사용)',
        responseSchema: z.object({
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        method: 'PUT',
        path: '/versions/{{version1Id}}/pricing/rules',
        service: 'pim',
        body: {
          basePriceRules: [
            {
      ...
      },
      {
        ...
        method: 'PUT',
        path: '/versions/{{version2Id}}/pricing/rules',
        service: 'pim',
        body: {
          basePriceRules: [
            {
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Active 버전 가격 조회 (Version 2, master API 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        method: 'GET',
        path: '/versions/{{version1Id}}/pricing/price-set',
        service: 'pim',
        queryParams: {
          variantId: '{{variantId}}',
        },
        expectedStatus: 200,
        description: 'Version 1 가격 조회 (특정 버전 API 사용)',
        responseSchema: z.object({
  ...
  // ========================================
  // Group 4: 가격 캐시 확인 (PRICE-013)
  // ========================================
  {
    id: 'PRICE-013',
    name: 'Publish 시 가격 캐시 생성 및 요약 반환',
    category: 'PIM > Pricing',
    validation: 'publish 시 캐시 생성 후 상품 조회에 priceSummary가 포함되는지 확인',
    steps: [
      {
        id: 'create-master',
        method: 'POST',
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'base/membership/tiered 규칙 설정',
      },
      {
        id: 'publish-version',
        method: 'PATCH',
        ...
        service: 'pim',
        expectedStatus: 200,
        description: '버전 Publish (가격 캐시 생성)',
      },
      {
        ...
        service: 'pim',
        expectedStatus: 200,
        description: '상품 상세 조회 (priceSummary 포함)',
        responseSchema: z.object({
          priceSummary: z.object({
            minBasePrice: z.literal(10000),
            maxBasePrice: z.literal(12000),
            minMembershipPrice: z.literal(9000),
            maxMembershipPrice: z.literal(11000),
            hasTieredPrices: z.literal(true),
          }),
        }),
      },
    ],
  ...
  // ========================================
  // Group 5: 오류 케이스 테스트 (PRICE-010 ~ PRICE-012)
  // ========================================
  {
    id: 'PRICE-010',
    name: '가격 규칙 검증 오류',
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Regular 고객, Red variant, qty 1 (active 버전 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Membership 고객, Red variant, qty 1 (active 버전 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Membership 고객, Red variant, qty 25 (active 버전 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Membership 고객, Blue variant, qty 1 (active 버전 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        expectedStatus: 200,
        description: 'Red variant 가격 세트 조회 (active 버전 사용)',
        responseSchema: z.object({
      ...
      },
      {
        ...
        expectedStatus: 201,
        description: 'Version 3 생성 (Draft, pricing rules도 복사됨)',
        extractFromResponse: { version3Id: 'id' },
      },
      {
        id: 'delete-all-rules',
        method: 'DELETE',
        path: '/versions/{{version3Id}}/pricing/rules',
        service: 'pim',
        expectedStatus: 204,
        description: 'Version 3의 모든 가격 규칙 삭제',
      },
      {
