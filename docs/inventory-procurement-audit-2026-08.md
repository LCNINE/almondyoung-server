...
| 5 | `procurement/` 모듈 분리 + 계층·예외 정렬 | §1.6 §1.7 | ~~4~~ 해소 | 0 |
| 6 | 재주문 제안 정리 | ⑥ | — | 0 |
| 7 | 종결·취소 상태 | ⑦ | — | **있음** |
| 8 | 잔가지 묶음 | ⑧ ⑩ | — | 소 |
| 9 | 발주 라인 생명주기 (항목 2·4 를 흡수) | ③ ④ ⑤ | — | 1건 |
| 10 | 파킹 2건 (계획 생성 `FOR UPDATE` / 승인 후 라인 추가) | — | 10-b 는 제품 결정 | 0 |
| 11 | `isSameSeoulDay` 이중 변환 수정 | ⑪ | — | 0 |

> 번호는 엄브렐러 이슈 #724 의 현황판과 일치시킨다. 항목 9 는 원래 이 목록에 없던 것으로,
> 항목 1 을 파는 과정에서 "발주 실무가 라인 단위 실행"이라는 사실이 확인돼 신설됐다.
> 상태(무엇이 끝났는지)는 이 문서가 아니라 이슈가 소유한다.
