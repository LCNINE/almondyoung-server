...
현재 오프라인 ZIP: `docs/demo-training/output/distribution/Almond-WMS-demo-manuals-markdown-2026-09-17.zip` (Markdown5 + PNG27). SHA-256: `a03ba730fe8790d60536225cb10cbf2b55eb84c66699d8ffce0227a471a4cf50`.

문서 용어 통일: 공개 매뉴얼 5개의 팀 명칭을 발주 담당자·입출고 담당자로 변경하고, 진행 주체는 개발팀으로 통일했다. 시연·실증 용어를 적용했으며 원본 ZIP도 갱신했다.

문서 어조 통일: 작업 흐름 문서의 제목·목차를 ‘예시 작업 흐름’으로 변경하고, 전 문서의 학습·지시 중심 표현을 작업 예시·입력값·동작 확인 중심 표현으로 수정했다. 데이터 보존과 중복 요청 방지 절차는 유지했다.
