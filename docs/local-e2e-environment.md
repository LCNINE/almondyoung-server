...
| 매칭 | — | ⛔ 미통과. 다만 막던 벽 둘은 치웠다 — 벽 ②(`resolve`/`upsert` 확장, #791) · 벽 ①(공급처 시드, #795) |

**매칭 한 칸을 막던 두 벽은 2026-09-06 에 모두 코드로 치웠다. 하지만 그 뒤로 이 칸을 «화면으로»
통과시킨 적은 아직 없다** — 다음 판의 첫 목표다. 여기서 또 막히면 그건 새 발견이다.
