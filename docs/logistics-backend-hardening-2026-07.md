...
> - 브랜치 `feat/sales-order-status-derivation`(설계·계획 docs 2 + T1 getStats FO 도출 · T2 dead 선언 · T3 ADR 정정(+인용 fix) · T4 현황판(+eslint import wrap fix) · 최종리뷰 정확성 fix, code tip `290d592f1`) → **develop 스쿼시 머지 대기(사용자 수동 머지)**.
