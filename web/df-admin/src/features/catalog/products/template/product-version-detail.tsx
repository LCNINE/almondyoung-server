...
import { useVersion } from "@/lib/services/catalog/versions"
...
export default function ProductVersionDetailTemplate() {
  const { masterId, versionId } = useParams<{
    masterId: string
    versionId: string
  }>()
  const navigate = useNavigate()
  const { data: product, isLoading } = useVersion(masterId!, versionId!)
