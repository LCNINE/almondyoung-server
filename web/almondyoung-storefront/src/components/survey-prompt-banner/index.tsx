...
export function SurveyPromptBanner({
  className,
}: Omit<SurveyPromptBannerProps, "countryCode"> & { countryCode?: string }) {
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              >
                {isLoading ? t("processing") : t("close")}
              </Button>
              <CustomButton
                asChild
                size="sm"
              ...
              >
                <LocalizedClientLink href="/shop-survey">{t("configure")}</LocalizedClientLink>
              </CustomButton>
            </div>
          </div>
        </div>
            ...
            <div className="min-w-0 flex-1 pr-4">
              ...
              <div className="mt-3 flex items-center gap-2">
                <CustomButton asChild size="sm" className="rounded-full">
                  <LocalizedClientLink href="/shop-survey">
                    {t("configure")}
                  </LocalizedClientLink>
                </CustomButton>
                ...
                >
                  {isLoading ? t("processing") : t("later")}
                </Button>
              </div>
            </div>
          </div>
