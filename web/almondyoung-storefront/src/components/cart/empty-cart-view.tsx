    ...
    <div className={`flex w-full flex-col ${bgColor}`}>
      ...
      <main className="flex flex-1 flex-col items-center justify-start px-4 pt-24 sm:px-6 sm:pt-32">
        <div className="flex w-full max-w-md flex-col items-center">
          ...
          <LocalizedClientLink
            href={"/category/cafe24-cat-499"}
            className="rounded-xl bg-[#ffa500] px-10 py-4 text-center text-[15px] font-semibold text-white transition-all hover:bg-[#e69500] sm:w-auto sm:text-[17px]"
          >
            {t("shopNow")}
          </LocalizedClientLink>
        </div>
