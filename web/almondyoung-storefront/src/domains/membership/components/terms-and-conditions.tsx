  ...
  return (
    <div className="space-y-6 text-sm leading-[19px] text-[#555d6d]">
      ...
      <div>
        ...
        <ul className="list-disc space-y-1.5 pl-5 marker:text-[#b0b3ba]">
          {isRecurring ? (
            <>
              <li>
                결제 주기: 매월 이용 기간의 마지막 날에 1회 자동 결제 (정기결제
                기준)
              </li>
              <li>
                갱신 사전 안내: 결제 예정일 7일 전에 가입하신 이메일로 결제
                예정일과 금액을 미리 안내드립니다.
              </li>
              <li>
                해지 시점: 결제 예정일 전까지 해지하시면 다음 주기부터 청구되지
                않으며, 이미 결제한 기간은 종료일까지 그대로 이용하실 수
                있습니다.
              </li>
              {hasPrices && (
                <li>
        ...
        <ul className="list-disc space-y-1.5 pl-5 marker:text-[#b0b3ba]">
          {isRecurring ? (
            <>
              ...
              <li>
                출금이 3회 실패하면 멤버십 자격이 회수되며, 자격이 부여되어
                있던 기간의 요금은 미납 요금으로 남습니다(제5조).
              </li>
              <li>
      ...
      <div>
        ...
        {/* 미납 조항. 부여 시점을 기준으로 청구하므로(할인 사용 여부 무관) 그 기준을 문언에 드러낸다. */}
        {isRecurring && (
          <>
            <h3 className="mt-4 mb-1.5 text-sm font-bold text-[#1a1c20]">
              제 5조 미납 요금
            ...
            <ul className="list-disc space-y-1.5 pl-5 marker:text-[#b0b3ba]">
              <li>
                회원의 결제 수단에서 요금이 수납되지 않아 회사가 멤버십 자격을
                회수한 경우, 회수 시점까지 이용 자격이 부여되어 있던 결제
                주기의 요금은 미납 요금으로 남습니다.
              </li>
              <li>
                미납 요금은 해당 주기에 회원이 멤버십 할인 등 혜택을 실제로
                이용하였는지와 관계없이 발생합니다. 이용 자격이 부여된 기간에
                대한 대가이기 때문입니다.
              </li>
              <li>
                미납 요금의 금액은 해당 주기에 청구된 금액 전액이며, 이용
                일수에 따라 나누어 계산하지 않습니다.
              </li>
              <li>
              ...
              <li>
                회사는 미납을 이유로 회원의 가입, 결제 수단 등록, 상품 구매를
                제한하지 않습니다.
              </li>
              <li>
