      ...
      {/* <div
        ...
        className={`hover:bg-gray-10! flex w-full cursor-pointer items-start gap-3 rounded-[10px] border p-[30px] transition-all ${
          selectedMethod === "payLater"
            ? "border-[#ffa500] bg-orange-50/10 ring-1 ring-[#ffa500]"
            : "border-[#d9d9d9] bg-white hover:bg-gray-50"
        }`}
      >
        <div className="mt-0.5 shrink-0">
          {selectedMethod === "payLater" ? (
            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#ffa500]">
        ...
        <div className="flex flex-1 flex-col gap-4">
          ...
          <div
            className={`relative mt-2 w-64 overflow-hidden rounded-xl bg-linear-to-br from-[#2C2C2E] to-[#1C1C1E] p-6 text-white shadow-lg sm:h-44 sm:w-72 ${selectedMethod === "payLater" ? "opacity-100 ring-2 ring-[#ffa500]/30" : "opacity-70 grayscale"} transition-all duration-300`}
          >
            <div className="absolute -top-10 -right-10 h-32 w-32 rounded-full bg-white/5 blur-2xl" />
            <div className="absolute -bottom-8 -left-8 h-32 w-32 rounded-full bg-[#ffa500]/20 blur-2xl" />
