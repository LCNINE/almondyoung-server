...
const LEGAL_RETENTION = [
  {
    basis: "전자상거래법",
    target: "계약 또는 청약철회 등에 관한 기록",
    period: "5년",
  },
  {
    basis: "전자상거래법",
    target: "대금결제 및 재화 등의 공급에 관한 기록",
    period: "5년",
  },
  {
    basis: "전자상거래법",
    target: "소비자의 불만 또는 분쟁처리에 관한 기록",
    period: "3년",
  },
  { basis: "전자상거래법", target: "표시·광고에 관한 기록", period: "6개월" },
  {
    basis: "전자금융거래법",
    target: "전자금융거래에 관한 기록",
    period: "5년",
  },
  {
    basis: "통신비밀보호법",
    ...
    <div>
      ...
      <Article title="제4조 (개인정보의 제3자 제공)">
        <p>
          ...
          처리하며, 정보주체의 별도 동의, 법률의 특별한 규정 등 「개인정보
          보호법」 제17조 및 제18조에 해당하는 경우에만 제3자에게 제공합니다.
        </p>
        <p>
          현재 회사는 이벤트·프로모션 협력사에 대한 제공(선택 동의 시)을
          제외하고 정기적으로 개인정보를 제3자에게 제공하고 있지 않습니다.
          배송·결제 등 서비스 제공에 필요한 처리는 제5조의 위탁에 해당합니다.
        </p>
      </Article>
      ...
      <Article title="제6조 (개인정보의 국외 이전)">
        ...
        <p className="pt-2">
          ...
          경우 회원가입 및 서비스 이용이 제한될 수 있습니다. 거부 의사는 제9조의
          개인정보 보호책임자 연락처로 접수하실 수 있습니다.
        </p>
      </Article>
      ...
      <Article title="제8조 (정보주체와 법정대리인의 권리·의무 및 행사 방법)">
        ...
        <ol className="list-decimal space-y-1 pl-5">
          ...
          <li>
            정보주체가 개인정보의 오류에 대해 정정을 요청하신 경우, 회사는
            정정을 완료할 때까지 해당 개인정보를 이용하거나 제공하지 않습니다.
          </li>
          <li>
      ...
      <Article title="제11조 (개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)">
        ...
        <ol className="list-decimal space-y-1 pl-5">
          ...
          <li>
            ...
            저장을 거부하시면 로그인이 필요한 일부 서비스 이용에 어려움이 있을
            수 있습니다.
          </li>
        </ol>
      </Article>
      ...
      <Article title="제13조 (정보주체의 권익침해에 대한 구제 방법)">
        ...
        <p className="pt-2">
          ...
          정정·삭제), 제37조(개인정보의 처리정지 등)에 따른 요구에 대하여
      ...
      <Article title="제14조 (개인정보처리방침의 변경)">
        ...
        <p>
          ...
          경우에는 변경사항의 시행 7일 전부터 서비스 공지사항을 통하여
          고지합니다. 다만 수집하는 개인정보의 항목, 이용목적의 변경 등과 같이
          정보주체의 권리에 중대한 영향을 미치는 변경의 경우에는 최소 30일 전에
          고지합니다.
        </p>
      </Article>
    </div>
