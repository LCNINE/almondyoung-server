...
const triggerClassName =
  "flex-1 cursor-pointer !rounded-none !border-0 !border-b-2 !border-b-transparent !bg-transparent px-4 py-3 text-sm font-bold text-[#666666] !shadow-none transition-colors focus-visible:!ring-0 focus-visible:!outline-none !after:hidden data-[state=active]:!border-0 data-[state=active]:!border-b-2 data-[state=active]:!border-b-[#ffa500] data-[state=active]:!bg-transparent data-[state=active]:!text-[#ffa500] data-[state=active]:!shadow-none hover:!bg-transparent hover:text-[#ffa500]"
