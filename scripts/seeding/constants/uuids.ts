...
export const FIXED_UUIDS = {
  ...
  ROLE_LOGISTICS_WORKER: '019d0004-0005-7000-a000-000000000005',
  ROLE_LOGISTICS_MANAGER: '019d0004-0006-7000-a000-000000000006',
  ...
  // provider-manager.service.ts 의 NHN SMS 리터럴과 같은 id 여야 조회 API 와 실제 발송이 같은 행을 가리킨다.
  PROVIDER_NHN_SMS: 'c1f4b8de-6a3f-4d1e-9c7a-2e5b8f0a4d13',
  PROVIDER_NHN_KAKAO: '019d0007-0004-7000-a000-000000000004',

  // Templates
  TEMPLATE_MEMBERSHIP_RENEWAL_UPCOMING: '019d0007-1001-7000-a000-000000000001',
  TEMPLATE_MEMBERSHIP_EXPIRY_UPCOMING: '019d0007-1001-7000-a000-000000000002',
  TEMPLATE_CMS_MEMBER_REJECTED: '019d0007-1001-7000-a000-000000000003',
  TEMPLATE_MANDATE_PENDING: '019d0007-1001-7000-a000-000000000004',
  TEMPLATE_CMS_MEMBER_REGISTERED: '019d0007-1001-7000-a000-000000000005',
  TEMPLATE_ORDER_SHIPPED: '019d0007-1001-7000-a000-000000000006',
  TEMPLATE_ORDER_PARTIALLY_SHIPPED: '019d0007-1001-7000-a000-000000000007',
  TEMPLATE_CLAIM_REQUESTED: '019d0007-1001-7000-a000-000000000008',
  TEMPLATE_CLAIM_RECEIVED: '019d0007-1001-7000-a000-000000000009',
  TEMPLATE_CLAIM_COLLECTED: '019d0007-1001-7000-a000-000000000010',
  TEMPLATE_CLAIM_COMPLETED: '019d0007-1001-7000-a000-000000000011',
  TEMPLATE_REFUND_COMPLETED: '019d0007-1001-7000-a000-000000000012',
  TEMPLATE_QNA_ANSWERED: '019d0007-1001-7000-a000-000000000013',
  TEMPLATE_USER_WELCOME: '019d0007-1001-7000-a000-000000000014',
  TEMPLATE_USER_WITHDRAWN: '019d0007-1001-7000-a000-000000000015',
  TEMPLATE_MEMBERSHIP_JOINED: '019d0007-1001-7000-a000-000000000016',
  TEMPLATE_MEMBERSHIP_CANCELLED: '019d0007-1001-7000-a000-000000000017',
  TEMPLATE_MEMBERSHIP_CANCEL_SCHEDULED: '019d0007-1001-7000-a000-00000000001a',
  TEMPLATE_COUPON_EXPIRING: '019d0007-1001-7000-a000-000000000018',
} as const;
