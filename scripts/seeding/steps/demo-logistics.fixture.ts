...
export const DEMO_LOGISTICS_FIXTURE = {
  ...
  suppliers: [
    { id: demoUuid(8, 1), code: 'DEMO-DOM', name: '데모 국내 공급사', leadTimeDays: [3, 4, 3, 5, 4] },
    { id: demoUuid(8, 2), code: 'DEMO-SEA', name: '데모 해상 공급사', leadTimeDays: [18, 21, 19, 23, 20] },
    { id: demoUuid(8, 3), code: 'DEMO-AIR', name: '데모 항공 공급사', leadTimeDays: [7, 8, 6, 9, 7] },
  ],
  catalog,
} as const;
