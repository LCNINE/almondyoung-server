...
export const digitalAsset = pgTable("digital_asset", {
  ...
  index("IDX_digital_asset_deleted_at").using("btree", table.deletedAt.asc().nullsLast()).where(sql`(deleted_at IS NULL)`),
]);

export const digitalAssetDigitalAssetLicenseCustomerCustomer = pgTable("digital_asset_digital_asset_license_customer_customer", {
  digitalAssetLicenseId: varchar("digital_asset_license_id", { length: 255 }).notNull(),
  customerId: varchar("customer_id", { length: 255 }).notNull(),
  id: varchar({ length: 255 }).notNull(),
  createdAt: timestamp("created_at", { withTimezone: true }).default(sql`CURRENT_TIMESTAMP`).notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).default(sql`CURRENT_TIMESTAMP`).notNull(),
  ...
  primaryKey({ columns: [table.digitalAssetLicenseId, table.customerId], name: "digital_asset_digital_asset_license_customer_customer_pkey" }),
  index("IDX_customer_id_1756491a2").using("btree", table.customerId.asc().nullsLast()),
  index("IDX_deleted_at_1756491a2").using("btree", table.deletedAt.asc().nullsLast()),
  index("IDX_digital_asset_license_id_1756491a2").using("btree", table.digitalAssetLicenseId.asc().nullsLast()),
  index("IDX_id_1756491a2").using("btree", table.id.asc().nullsLast()),
]);

export const digitalAssetDigitalAssetLicenseOrderOrder = pgTable("digital_asset_digital_asset_license_order_order", {
  digitalAssetLicenseId: varchar("digital_asset_license_id", { length: 255 }).notNull(),
  ...
  primaryKey({ columns: [table.digitalAssetLicenseId, table.orderId], name: "digital_asset_digital_asset_license_order_order_pkey" }),
  index("IDX_deleted_at_2ecd61916").using("btree", table.deletedAt.asc().nullsLast()),
  index("IDX_digital_asset_license_id_2ecd61916").using("btree", table.digitalAssetLicenseId.asc().nullsLast()),
  index("IDX_id_2ecd61916").using("btree", table.id.asc().nullsLast()),
  index("IDX_order_id_2ecd61916").using("btree", table.orderId.asc().nullsLast()),
]);

export const digitalAssetDigitalAssetLicenseOrderOrderLineItem = pgTable("digital_asset_digital_asset_license_order_order_line_item", {
  digitalAssetLicenseId: varchar("digital_asset_license_id", { length: 255 }).notNull(),
  orderLineItemId: varchar("order_line_item_id", { length: 255 }).notNull(),
  id: varchar({ length: 255 }).notNull(),
  createdAt: timestamp("created_at", { withTimezone: true }).default(sql`CURRENT_TIMESTAMP`).notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).default(sql`CURRENT_TIMESTAMP`).notNull(),
  deletedAt: timestamp("deleted_at", { withTimezone: true }),
}, (table) => [
  primaryKey({ columns: [table.digitalAssetLicenseId, table.orderLineItemId], name: "digital_asset_digital_asset_license_order_order_line_item_pkey" }),
  index("IDX_deleted_at_2857e8d8b").using("btree", table.deletedAt.asc().nullsLast()),
  index("IDX_digital_asset_license_id_2857e8d8b").using("btree", table.digitalAssetLicenseId.asc().nullsLast()),
  index("IDX_id_2857e8d8b").using("btree", table.id.asc().nullsLast()),
  index("IDX_order_line_item_id_2857e8d8b").using("btree", table.orderLineItemId.asc().nullsLast()),
]);

export const digitalAssetLicense = pgTable("digital_asset_license", {
  id: text().primaryKey(),
  digitalAssetId: text("digital_asset_id").notNull().references(() => digitalAsset.id, { onUpdate: "cascade" }),
  customerId: text("customer_id").notNull(),
  orderItemId: text("order_item_id"),
  isExercised: boolean("is_exercised").default(false).notNull(),
  createdAt: timestamp("created_at", { withTimezone: true }).default(sql`now()`).notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).default(sql`now()`).notNull(),
  deletedAt: timestamp("deleted_at", { withTimezone: true }),
}, (table) => [
  index("IDX_digital_asset_license_deleted_at").using("btree", table.deletedAt.asc().nullsLast()).where(sql`(deleted_at IS NULL)`),
  index("IDX_digital_asset_license_digital_asset_id").using("btree", table.digitalAssetId.asc().nullsLast()).where(sql`(deleted_at IS NULL)`),
]);

export const digitalAssetProductVariant = pgTable("digital_asset_product_variant", {
  digitalAssetId: varchar("digital_asset_id", { length: 255 }).notNull(),
  productVariantId: varchar("product_variant_id", { length: 255 }).notNull(),
  id: varchar({ length: 255 }).notNull(),
  createdAt: timestamp("created_at", { withTimezone: true }).default(sql`CURRENT_TIMESTAMP`).notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).default(sql`CURRENT_TIMESTAMP`).notNull(),
  deletedAt: timestamp("deleted_at", { withTimezone: true }),
}, (table) => [
  primaryKey({ columns: [table.digitalAssetId, table.productVariantId], name: "digital_asset_product_variant_pkey" }),
  index("IDX_deleted_at_-10d7f7faa").using("btree", table.deletedAt.asc().nullsLast()),
  index("IDX_digital_asset_id_-10d7f7faa").using("btree", table.digitalAssetId.asc().nullsLast()),
  index("IDX_id_-10d7f7faa").using("btree", table.id.asc().nullsLast()),
  index("IDX_product_variant_id_-10d7f7faa").using("btree", table.productVariantId.asc().nullsLast()),
]);
