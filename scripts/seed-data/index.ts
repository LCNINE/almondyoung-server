...
interface EnvConfig {
  ...
  NOTIFICATION_NHN_SMS_APP_KEY: string;
  NOTIFICATION_NHN_SMS_SECRET_KEY: string;
  NOTIFICATION_NHN_SMS_SEND_NO: string;
...
function loadEnvConfig(): EnvConfig {
  const config: EnvConfig = {
    ...
    NOTIFICATION_NHN_SMS_APP_KEY:
      process.env.NOTIFICATION_NHN_SMS_APP_KEY || process.env.NHN_SMS_APP_KEY || '',
    NOTIFICATION_NHN_SMS_SECRET_KEY:
      process.env.NOTIFICATION_NHN_SMS_SECRET_KEY || process.env.NHN_SMS_SECRET_KEY || '',
    NOTIFICATION_NHN_SMS_SEND_NO:
      process.env.NOTIFICATION_NHN_SMS_SEND_NO || process.env.NHN_SMS_SEND_NO || '',
    ...
    await runSeeder(
      ...
      () =>
        seedNotification(
          ...
          config.NOTIFICATION_NHN_SMS_APP_KEY,
          config.NOTIFICATION_NHN_SMS_SECRET_KEY,
          config.NOTIFICATION_NHN_SMS_SEND_NO,
